		...
		<div class="main">
			<nav class="navbar navbar-expand navbar-light navbar-bg">
				...
				<div class="customer__container">
					<h1 class="customer__title">Quản lý phim </h1>
					...
					<td class="customer__table--item" >Tên Phim</td>
					<td class="customer__table--item" >Poster</td>
					<td class="customer__table--item" >Ngày chiếu</td>
					<td class="customer__table--item" >Ngày kết thúc</td>
                    <td class="customer__table--item" >Thời gian</td>
					<td class="customer__table--item" >độ tuổi</td>
					<td class="customer__table--item" >Thể loại</td>
					<td class="customer__table--item" >Kích cỡ</td>
					<td class="customer__table--item" >Ngôn ngữ</td>
					...
					<tr class="customer__table--body">
						...
						<td  class="customer__table--body-item" ><?php echo $row['name']?></td>
						<td  class=" customer__table--body-item">
                            <div class="customer__table--body-item__img" style="background-image: 
                            url(<?php echo $row['poster']?>);" ></div>
                        </td>
						<td  class="customer__table--body-item" ><?php echo $row['date_start']?></td>
                        <td  class="customer__table--body-item" ><?php echo $row['date_end']?></td>
						<td  class="customer__table--body-item" ><?php echo $row['time']?>p</td>
						<td  class="customer__table--body-item" ><?php echo $row['censoship']?>+</td>
						<td  class="customer__table--body-item" ><?php echo $row['movie_type']?></td>
						<td  class="customer__table--body-item" ><?php echo $row['language']?></td>
						 <td  class="customer__table--body-item" > 
							<!-- <a  href="themsanpham.php" class="customer__table--body-btn-cre" >Thêm</a> -->
							<a  href="Suaphim.php?idkh=<?php echo $row['id']?>"   class="customer__table--body-btn-upd" >Sửa</a>
							<a href="Xoaphim.php?idkh=<?php echo $row['id']?>" class="customer__table--body-btn-del">Xóa</a>
						 </td>
					</tr>
                     <?php
					 }
